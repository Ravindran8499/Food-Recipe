...
const RecipeItem = ({ id, image_url, publisher, title }) => {
  // console.log(id);
  return (
    <div className="flex max-w-80 flex-col gap-2 rounded-lg border border-gray-300 bg-white p-1 shadow transition-all duration-1000 hover:scale-105 dark:border-gray-700 dark:bg-gray-800">
